...
class FirefoxProgressBar @JvmOverloads constructor(
    ...
    fun initialize(browserFrag: BrowserFragment) {
        ...
        //browserFrag.mLoadingProgressTip=
        ...
        ///////////////////////////add by kuan///////////////////////////
        browserFrag.session.progress.observe(browserFrag, object : NonNullObserver<Int>() {
            public override fun onValueChanged(value: Int) {
                browserFrag.setLoadingProgressTip(value);
                if(value>=99)
                {
                    browserFrag.hideWelcomeLayer();
                }
            }
        })
        //////////////////////////////end///////////////////////////////////
